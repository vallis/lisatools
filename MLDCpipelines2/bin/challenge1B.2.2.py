...
run('%(execdir)s/makesource-BBH.py --seed=%(seed)s --distance=1e10 --requestSN=%(requestsn)s --coalescTime=400 --coalescRange=40 --sourceName="SMBH-1.2.2" Source/BH-1.2.2.xml' % globals())
