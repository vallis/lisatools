...
int main (int argc, char * const argv[])
{
	try {
		...
		double v(9.0), tmpv;
		cout.precision(13);
		cout << "Test MathUtils::ifloor :" << endl;
		cout << "----------- :" << endl;
		tmpv = v;
		cout << tmpv << " --> " << floor(tmpv) << " --> " << MathUtils::ifloor(tmpv) << " ==> "  << floor(tmpv)-MathUtils::ifloor(tmpv)  << endl;
		tmpv = v + 1.0e-15;
		cout << tmpv << " --> " << floor(tmpv) << " --> " << MathUtils::ifloor(tmpv) << " ==> "  << floor(tmpv)-MathUtils::ifloor(tmpv)  << endl;
		tmpv = v + 1.0e-10;
		cout << tmpv << " --> " << floor(tmpv) << " --> " << MathUtils::ifloor(tmpv) << " ==> "  << floor(tmpv)-MathUtils::ifloor(tmpv)  << endl;
		...
		cout << "Test MathUtils::iceil :" << endl;
		cout << "----------- :" << endl;
		tmpv = v;
		cout << tmpv << " --> " << ceil(tmpv) << " --> " << MathUtils::iceil(tmpv)  << " ==> " << ceil(tmpv)-MathUtils::iceil(tmpv) << endl;
		tmpv = v + 1.0e-15;
		cout << tmpv << " --> " << ceil(tmpv) << " --> " << MathUtils::iceil(tmpv)  << " ==> " << ceil(tmpv)-MathUtils::iceil(tmpv) << endl;
		tmpv = v + 1.0e-10;
		cout << tmpv << " --> " << ceil(tmpv) << " --> " << MathUtils::iceil(tmpv)  << " ==> " << ceil(tmpv)-MathUtils::iceil(tmpv) << endl;
