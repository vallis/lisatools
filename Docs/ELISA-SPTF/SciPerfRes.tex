...
\begin{figure}[H]
\begin{center}
   \includegraphics[width=1\textwidth]{FigGBTyson/confusion.eps} % requires the graphicx package
...
\begin{figure}[H]
\begin{center}
   \includegraphics[angle=270,width=0.75\textwidth]{FigGBTyson/SNR.eps} % requires the graphicx package
...
\begin{figure}[H]
\begin{center}
   \includegraphics[angle=270, width=0.75\textwidth]{FigGBTyson/Amp.eps} % requires the graphicx package
...
\begin{figure}[H]
\begin{center}
   \includegraphics[angle=270,width=0.75\textwidth]{FigGBTyson/fdot.eps} % requires the graphicx package
...
\begin{figure}[H]
\begin{center}
   \includegraphics[angle=270,width=0.75\textwidth]{FigGBTyson/inc.eps} % requires the graphicx package
...
\begin{figure}[H]
\begin{center}
   \includegraphics[angle=270, width=0.75\textwidth]{FigGBTyson/Omega.eps} % requires the graphicx package
...
\caption{\label{fig:SNRMiniLISA} Angle-averaged SNR for equal-mass,
  ...
  \eb{If we decide to keep this and the following plots, I should replace C1
    by C5.}}
\end{center}
\end{figure}
%
