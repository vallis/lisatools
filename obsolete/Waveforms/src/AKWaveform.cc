...
/******************  CVS info ************************ 
*/
#define SVNIDAKWAVEFORMCC "$Id: AKWaveform.cc 275 2007-01-12 12:45:51Z stasbabak $"
...
int AKWaveform::GetWaveform(double ps0, std::vector<double>& hPlus, std::vector<double>& hCross){
