...
run('bin/makesource-EMRI.py --seed=%s --distance=1e6 --requestSN=100 Source/EMRI-1.xml' % (seed+6))

run('bin/makesource-EMRI.py --seed=%s --distance=1e6 --requestSN=80 Source/EMRI-2.xml' % (seed+7))
