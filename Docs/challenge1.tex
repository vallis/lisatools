...
\item{{\bf Challenge 1}} -- The goal of this challenge is to foster the development and validation of building blocks of and basic tools for LISA data analysis and tackle analysis of data sets containing a single signal or non-overlaping multiple signals embedded in Gaussian and stationary noise with no contribution from galactic and/or extragalactic foregrounds. Training data sets (where all the source parameters are open) will also be provided. 
...
\item{{\bf Challenge 3}} -- The goal of this challenge is to test a more realistic data analysis scenario, with multiple sources with more general waveforms and/or more realistic noise contributions (non-stationary, non-Gaussian). Gaps might also be introduced in the data sets. Details are TBD.
...
The challange data sets with all the relevant information (including the present documents), relevant software, and links to other resources are available at {\tt http://astrogravs.nasa.gov.edu/docs/mldc/}. The Task Force distrib
...
\hline\hline
& & & & & &  \\
Challenge ID & Length data set & signal            & waveform        & comments                               & Noise & Foregrounds \\
& & & & & & \\
\hline
& & & & & &  \\
...
& & & & & &  \\
\hline
1.1.1a       & 1 year             & 1 DWD             & no fdot         & f $\approx 1$ mHz, SNR $approx 10-20$  & G-S          & no \\
1.1.1b       & 1 year             & 1 DWD             & no fdot         & f $\approx 3$ mHz, SNR $\approx 10-20$  & G-S        & no \\
1.1.1c       & 1 year             & 1 DWD             & no fdot         & f $\approx 10$ mHz, SNR $\approx 10-20$  & G-G    & no \\
\hline
1.1.2       & 1 year              & 5 (true) + 15 (mock) VB     & no fdot         & f = 0.5-12 mHz SNR $> 10$  & G-S         & no \\
1.1.3       & 1 year              & 20 unknown (par) DWD          & no fdot         & whole band, SNR $> 10$  & G-S          & no \\
1.1.4       & 1 year              & $\approx 50$ unknwon (num/par) DWD          & no fdot         & $f \approx 3$ with $\Delta f \approx 15\,\mu$Hz, SNR $> 5$  & G-S          & no \\
\hline
