...
/******************  CVS info ************************ 
#define CVSTAG "$Name:  $"
#define CVSHEADER "$Header: /afs/aeiw/cvsroot/waves/people/stas/LISAWP/waveforms/src/BaseIntegr.cc,v 1.1 2007/09/18 21:56:06 stba Exp $" 
*/
...
void BaseIntegr::SimplestIntegrator(Matrix<double> ystart, \
Matrix<double> dydx, Matrix<double>& yend, double tstart, double dt,\
int n){

   for(int i=0; i<n; i++){
       yend(i) = ystart(i) + dydx(i)*dt;
   }
