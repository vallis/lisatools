...
/* VERSION: 2.1.1                                                           */
/*                                                                          */
/* gcc -O2 -o Fast_XML_SL Fast_XML_SL.c IO/lisaxml.c IO/ezxml.c             */
...
int main(int argc,char **argv) {
  ...
  if (argc < 3)
  {
    ...
    printf("   ./Fast_XML_SL name sources.txt\n");
  ...
  if ((sourcefile = fopen(argv[2],"r")) == NULL)
  {
    ...
    strcpy(Name,argv[1]);
    sprintf(outputname, "XML/%s_synthLISA_noisefree.xml", Name);
    sprintf(binaryname, "XML/%s_synthLISA_noisefree.bin", Name);
