...
\end{displaymath}
%PROBLEM: Neil: insert conversion to LISA Simulator values?
...
%PROBLEM: Verify definition of SNR?
\small
\begin{tabular}{llll}
\br
{Parameter} &
...
%PROBLEM: Check the 1/2 for the one-sided spectrum.
