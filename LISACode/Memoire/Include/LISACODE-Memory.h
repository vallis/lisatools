...
class Memory
{
 protected:
  ...
  vector<Serie> ListTmpData; // List of stored datas' series (RAM)
   ...
   */
  double tStoreData; // Time during which the data are preserves (RAM)
  /*!\brief Time step for recording data */
  double tStepRecord; //Step for recording data
 ...
 public:
  ...
  double gData(int SerieNumber, double delay) const; // Return the data of specified serie delayed by specified delay.
