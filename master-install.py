...
if checkpackage('synthlisa') < LooseVersion('1.3.7') or newsynthlisa:
    print "--> Installing Synthetic LISA"
    installpackage('http://www.vallis.org/software/synthLISA-1.3.7.tar.gz',prefix=libdir,keepdownload=False)
