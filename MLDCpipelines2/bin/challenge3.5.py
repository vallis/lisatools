...
run('%(mydir)s/makesource-StochasticBackground.py --seed=%(lcseed)s --PSD=1.0e-47 --randomizePSD=0.3 --pixelRefinement=%(pixelref)s LISACode/source-Background.xml' % globals())
